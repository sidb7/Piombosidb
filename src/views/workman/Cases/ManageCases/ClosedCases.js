...
const ClosedCases = (args) => {
  ...
  return (
    <div>
      ...
      <AccordionItem>
      <AccordionHeader  style={{boxShadow:"1px 1px 8px  rgba(128, 128, 128, 0.577)"}} targetId={e.id}> <span className="fs-4 d-flex align-items-center"> {e.Title} </span></AccordionHeader>
