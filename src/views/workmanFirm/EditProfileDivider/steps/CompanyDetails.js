              ...
              <Row>
                ...
                <Col md="6" className="mb-1">
                  ...
                  <Select
                    ...
                    value={{value:"PartnerShip",label:"PartnerShip"}}
              ...
              <Row>
                <Col md="6" className="mb-1">
                  ...
                  <Input
                    ...
                    readOnly
                    value={"711-2880 Nulla St., Mankato"}
                    // onChange={(e) => handleEmail(e.target.value)}
                  />
                </Col>
                <Col md="6" className="mb-1">
              ...
              <Row>
                <Col md="6" className="mb-1">
                  ...
                  isDisabled
                    ...
                    defaultValue={{value:"Mumbai",label:"Mumbai"}}
                  />
                </Col>
                <Col md="6" className="mb-1">
                  <Label className="form-label" for={`state-${type}`}>
                  ...
                  <Select
                    ...
                    classNamePrefix="select"
                    isDisabled
                    value={{value:"Maharashtra",label:"Maharashtra"}}
                  />
                </Col>
              </Row>
              <Row>
