               ...
               <div className="position-absolute start-0 ms-1" style={{cursor:"pointer"}}  onClick={()=>{setExpand(!Expand)}} > {Expand!=true?<BiExpand size={20}/>:<BiCollapse size={20}/> } </div>
                ...
                <div
                  ...
                  style={{
                    ...
                    maxHeight: (Expand===true)? "500px":"250px",
                    overflowY: "auto",
                ...
                >
                  ...
                  <div className="col-3 text-center bg-primary text-light py-1 d-flex justify-content-center align-items-center position-sticky top-0">
                    <b>Product Name</b>
                  </div>
                  <div
