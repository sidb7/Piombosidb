...
const LoginWorkman = () => {
  ...
  let data = [
     ...
     {
      email: "workman1@Piombo.com",
      pass: "12345",
      Phone: "12345678",
      type:"workman-Individual"
    },
    {
      email: "workman2@Piombo.com",
      pass: "12345",
      Phone: "12345678",
      type: "workman-Individual"
    },
    {
      email: "workman3@Piombo.com",
      pass: "12345",
      Phone: "12345678",
      type: "workman-Firm"
    },
            ...
            {rSelected == 1 ? (
              ...
              >
                ...
                <Button
                  ...
                  block
                tag={Link}
                to={(site!="")?`/${site}/dashboard`:"/login-workman"}
