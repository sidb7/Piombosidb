                  ...
                  <div className="mb-1">
                    ...
                    <Select
                      ...
                      options={[
                        ...
                        { value: "designContract", label: "Design & Contracting" },
                      
                      ]}
                      onChange={(e) => {
                        setStakeHolder(e);
                        setStakeHolderType( { value: "Select type", label: "Select type" })
                      }}
                    />
                    <br />
                    ...
                    <Select
                      ...
                      required
                      options={(stakeholder.value!="developer")?
                      (stakeholder.value==="enterprise")?[
